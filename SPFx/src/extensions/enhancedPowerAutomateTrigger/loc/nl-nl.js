define([], function () {
  return {
    ...
    SuccessDialogSubTextWithMessage:
      "De werkstroom is met succes gestart en geeft het volgende bericht terug: '$message'.",
    SuccessDialogSubTextWithoutMessage: "De werkstroom is met succes gestart.",
    FailedDialogSubTextWithMessage:
      "De werkstroom is gestart, maar faalde vervolgens en gaf het volgende bericht terug: '$message'. Probeer het opnieuw.",
    ...
    WaitingForFlowResponseSpinnerText:
      "Wachten op antwoord van de werkstroom...",
